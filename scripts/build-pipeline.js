...
class BuildPipeline {
  ...
  async validate() {
    ...
    const checks = [
      ...
      { name: 'CSS file', path: this.environment === 'production' ? 'static/css/styles.min.css' : 'static/css/styles.css' },
...
if (require.main === module) {
  ...
  const environment = args.includes('--prod') || args.includes('--production') ? 'production' : 
                     args.includes('--dev') || args.includes('--development') ? 'development' : 
